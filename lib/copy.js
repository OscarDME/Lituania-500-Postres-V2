// VIENINTELIS MATOMO TURINIO ŠALTINIS — visas nukreipimo puslapio tekstas yra čia.
// Komponentuose neturi būti įrašytų eilučių.
export const copy = {
  metadata: {
    title: "500 sveikų pyragų — Močiutė Aldona",
    description:
      "500 minkštų, purių ir gardžių pyragų receptų: visiškai be glitimo, pieno produktų ir pridėtinio cukraus.",
  ...
  hero: {
    ...
    headline: {
      before: "KAI PAMATYSI TAI, Į ",
      accent: "SVEIKUS SKANĖSTUS",
      after: " NIEKADA NEBEPAŽVELGSI TAIP, KAIP IKI ŠIOL.",
    },
    subheadline:
      "Rask 500 purių, drėgnų ir neįtikėtinai skanių pyragų receptų — nė gramo glitimo, laktozės ar cukraus. Skanauk kiekvieną kąsnį ramia širdimi, be jokių apribojimų.",
    ctaLabel: "TAIP, NORIU RECEPTŲ",
    starsAriaLabel: "Įvertinimas 5 iš 5 žvaigždučių",
    starsRating: "5.0",
    socialProof: "+3 200 patenkintų klientų",
    trustChips: [
      { icon: "🌾", text: "Be glitimo" },
      { icon: "🥛", text: "Be pieno produktų" },
    ...
    floatingBadges: {
      speed: { icon: "⏱️", top: "Paruošiama vos per", bottom: "20 min." },
  ...
  benefits: {
    ...
    items: [
      ...
      { icon: "🌾", title: "Nereikia jokių specialių miltų" },
      { icon: "⚡", title: "Greiti pyragai vos per 20 minučių" },
      { icon: "💚", title: "Be pieno ir be cukraus" },
      { icon: "📖", title: "Paprastos instrukcijos žingsnis po žingsnio" },
    ],
  },

  samples: {
    kicker: "Pirmiausia išbandyk",
    headline: "NEĮTIKĖTINAI GARDŪS PYRAGAI (SVEIKESNĖ VERSIJA):",
  ...
  moreRecipesCta: {
    ...
    big: "493",
    post: "PYRAGŲ RECEPTŲ...",
    ctaLabel: "ATSISIŲSTI SAVO KOPIJĄ DABAR",
  },

  testimonials: {
    kicker: "Tikri atsiliepimai",
    headline: "PAŽIŪRĖK, KĄ SAKO TIE, KURIE JAU KEPA SU MUMIS",
    subheadline: "Kuo dalinasi mūsų mokiniai",
    studentsBadge: "+ 3 200 sertifikuotų mokinių",
    items: [
      {
  ...
  categories: {
    ...
    groups: [
      ...
      {
        title: "100 modernių pyragų",
        items: [
          { src: "/preview/1-7.webp", alt: "Modernus pyragas 1" },
          { src: "/preview/2-6.webp", alt: "Modernus pyragas 2" },
          { src: "/preview/3-5-1.webp", alt: "Modernus pyragas 3" },
          { src: "/preview/4-3.webp", alt: "Modernus pyragas 4" },
        ],
      },
      {
  ...
  finalCta: {
    ...
    headline: "MOČIUTĖS ALDONOS ® 500 PYRAGŲ KNYGA",
    ...
    regularPriceLabel: "ANKSTESNĖ KAINA:",
    regularPrice: "59,90 €",
    regularPriceSuffix: "...",
    offerPriceLabel: "Tik šiandien",
    offerCurrency: "",
    offerPrice: "8,90 €",
  ...
  delivery: {
    ...
    items: [
      ...
      { icon: "✅", text: "Gali juos peržiūrėti ir planšetėje." },
      { icon: "♾️", text: "Prieiga visam gyvenimui: įskaitant visus naujus receptus." },
  ...
  guarantee: {
    ...
    headline: "IŠBANDYK BE RIZIKOS — 14 dienų besąlyginė garantija.",
    body: "Turi 14 dienų juos išbandyti. Jei receptai tavęs neįtikins, grąžinsiu tavo pinigus iki paskutinio cento. Be jokių komplikacijų. Be streso.",
    alt: "14 dienų besąlyginės garantijos antspaudas",
    image: { src: "/guarantee-badge.webp", alt: "14 dienų garantija" },
  },
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Ar tikrai skanus pyragas be kviečių, pieno, laktožės ir cukraus?",
